  ...
  return courseData ?  (
    <>
        <div className='flex md:flex-row flex-col-reverse gap relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
          ...
          {/* right column  */}
          <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hiden bg-white min-w-[300px] sm:min-w-[420px]'>
            ...
            <button onClick={enrollCourse} className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>{isAlreadyEnrolled ? 'Already Enrolled' : 'Enroll Now'}
            </button>
